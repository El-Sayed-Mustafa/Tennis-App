...
class Club {
  ...
  Club copyWith({
    ...
    List<String>? roleIds,
    String? clubChatId,
    List<String>? singleMatchesIds,
    List<String>? doubleMatchesIds,
    List<String>? singleTournamentsIds,
    List<String>? doubleTournamentsIds,
    int? numberOfRatings,
    ...
    return Club(
      ...
      clubAdmin: clubAdmin ?? this.clubAdmin,
      ...
      matchPlayed: matchPlayed ?? this.matchPlayed,
      totalWins: totalWins ?? this.totalWins,
      roleIds: roleIds ?? this.roleIds,
      clubChatId: clubChatId ?? this.clubChatId,
      singleMatchesIds: singleMatchesIds ?? this.singleMatchesIds,
      doubleMatchesIds: doubleMatchesIds ?? this.doubleMatchesIds,
      singleTournamentsIds: singleTournamentsIds ?? this.singleTournamentsIds,
      doubleTournamentsIds: doubleTournamentsIds ?? this.doubleTournamentsIds,
